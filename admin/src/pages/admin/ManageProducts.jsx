      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="relative inline-block">
            <div className="absolute inset-0 rounded-2xl blur-2xl opacity-30" style={{ background: `linear-gradient(135deg, ${BRAND_COLOR}, #d4a574)` }}></div>
            <div className="relative bg-gradient-to-r from-white to-gray-50 rounded-2xl p-6 border-2 shadow-xl" style={{ borderColor: BRAND_COLOR }}>
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-xl flex items-center justify-center text-white shadow-lg" style={{ background: `linear-gradient(135deg, ${BRAND_COLOR}, #d4a574)` }}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Create, update, and manage your product catalog</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-100 p-3 mb-6">
          <div className="flex flex-wrap gap-2">
            {tabs.map((tab, index) => (
              <motion.button
                ...
                className={`
                  relative px-6 py-3.5 rounded-xl font-semibold text-sm
        ...
        <motion.div layout className="bg-white rounded-2xl shadow-2xl border-2 border-gray-100 overflow-hidden">
            ...
            {isLoading ? (
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  <div className="h-12 w-12 rounded-xl animate-pulse" style={{ backgroundColor: `${BRAND_COLOR}40` }}></div>
                  <div className="flex-1 space-y-3">
                    <div className="h-8 rounded-lg animate-pulse w-1/4" style={{ backgroundColor: `${BRAND_COLOR}40` }}></div>
