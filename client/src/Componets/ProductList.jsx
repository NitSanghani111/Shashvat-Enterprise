  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <h1 className="text-4xl font-bold mb-8 text-center">
        ...
        <span className="relative inline-block" style={{ color: '#c5b173' }}>
          Latest
          <span className="absolute bottom-0 left-0 w-full h-1" style={{ backgroundColor: '#c5b173' }}></span>
        </span>
        ...
        {allProducts !== null ? (
          ...
          <div className="col-span-full flex justify-center py-12">
            <div className="animate-pulse flex space-x-4">
              <div className="rounded-full h-12 w-12" style={{ backgroundColor: 'rgba(197, 177, 115, 0.2)' }}></div>
              <div className="flex-1 space-y-4 py-1">
                <div className="h-4 rounded w-3/4" style={{ backgroundColor: 'rgba(197, 177, 115, 0.2)' }}></div>
