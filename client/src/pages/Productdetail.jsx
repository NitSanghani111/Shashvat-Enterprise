    ...
    <div className="bg-gray-50 min-h-screen pb-12">
            ...
            <div className="bg-white rounded-lg overflow-hidden flex flex-col items-center">
              <div className="w-full max-w-md mx-auto relative">
                <div className="relative overflow-hidden rounded-lg border-2 border-gray-100">
                  ...
                  {isHovering && (
                    <div
                      className="absolute w-20 h-20 border-2 pointer-events-none transform -translate-x-1/2 -translate-y-1/2 transition-all duration-100 "
                      style={{
                        borderColor: '#c5b173',
                        backgroundColor: 'rgba(197, 177, 115, 0.2)',
            ...
            <div className="flex flex-col">
              ...
              {isHovering && (
                <div className="mb-6 bg-gray-50 rounded-lg p-4 absolute">
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-transparent pointer-events-none" style={{ backgroundColor: 'rgba(197, 177, 115, 0.05)' }} />
                  </div>
                </div>
              )}
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <li className="flex items-center">
                    <span className="w-3 h-3 rounded-full mr-2" style={{ backgroundColor: '#c5b173' }}></span>
                    <span>
                      Category:{" "}
          ...
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px">
              <button
                ...
                style={{
                  borderBottomColor: activeTab === "specifications" ? '#c5b173' : 'transparent'
                }}
              >
                Specifications
              </button>
              <button
                ...
                style={{
                  borderBottomColor: activeTab === "details" ? '#c5b173' : 'transparent'
                }}
              >
                Product Details
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-12">
        <div className="flex items-center justify-center mb-8">
          ...
          <h2 className="px-6 text-2xl font-bold" style={{ color: '#c5b173' }}>
            Similar Products
          </h2>
          <div className="h-0.5 bg-gray-200 flex-1"></div>
        </div>
